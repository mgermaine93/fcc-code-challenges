...
suite('Unit Tests', function () {
  ...
  function weirdNumbers(delta) {
    // returns 1 + the argument - a random decimal
    // so for the second test, it does:
    // 1 + 0.2 - (anywhere from 0.0001-ish to 0.99999-ish)
  ...
  suite('Comparisons', function () {
    ...
    test('#approximately', function () {
      // the range for this would be 0.5 to 1.5
      assert.approximately(weirdNumbers(0.5), 1, 0.5);
      // the range for this would be 0.2 to 1.2
