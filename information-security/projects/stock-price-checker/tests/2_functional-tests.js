    ...
    test('Viewing the same stock and liking it again: `GET` request to `/api/stock-prices/`', (done) => {
        ...
        chai
            ...
            .end(function (err, res) {
                ...
                assert.property(res.body.stockData, 'likes', 'the response object "stockData" should have a property of "likes"')
                assert.isNumber(res.body.stockData.likes, 'the "likes" property should be of type number')
                assert.deepEqual(res.body.stockData.likes, numLikes, 'after trying to like a stock that you have already liked, the "likes" property should remain unchanged')
                done();
            });
    });
    ...
    test('Viewing two stocks: `GET` request to `/api/stock-prices/`', (done) => {
        ...
        chai
            ...
            .end(function (err, res) {
                ...
                assert.lengthOf(res.body.stockData, 2, 'the response object "stockData" should have a property that is of type array and has a length of 2')
